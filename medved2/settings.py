"""
Django settings for medved2 project.
...
SECRET_KEY = 'django-insecure-w%ki77$l89j+)d*2qh9&h28)^qby5vsfgh2@o_7r^trt=)jtug'
...
WSGI_APPLICATION = 'medved2.wsgi.application'
...
# Для использования youtube plugin на локальном сервере необходимо прописать настройки (он берётся только из static/)
...
# Путь для сохранения файлов через ckeditor_uploader
